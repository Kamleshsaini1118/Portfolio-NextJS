  ...
  return (
    <section>
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        ...
        description="We'll collaborate to map out your website's goals, target audience, and key functionalities. We'll discuss things like site structure, navigation, and contect requirements."
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        description= "This is where the magic happens! Based on the approved desgin, I'll translate everything into functional code, building your website from the ground up."
        >
          <CanvasRevealEffect
            animationSpeed={3}
